...
const FROZEN: [string, string, number][] = [
  ...
  ["src/components/site/CategoryFilterChips.tsx", "bg-brand-orange/10", 1],
  ["src/components/site/CharterToc.tsx", "text-foreground/65", 1],
  ["src/components/site/DocumentFileRow.tsx", "text-foreground/50", 1],
  ["src/components/site/EventYearChips.tsx", "bg-brand-orange/10", 1],
  ["src/components/site/FederationSidebar.tsx", "text-foreground/60", 1],
  ["src/components/site/NewsCard.tsx", "text-white/75", 1],
  ["src/components/site/NewsCard.tsx", "text-white/85", 1],
  ["src/components/site/NewsGallery.tsx", "text-white/90", 1],
  ["src/components/site/SiteFooter.tsx", "text-white/75", 2],
  ["src/components/site/SiteFooter.tsx", "text-white/90", 2],
  ["src/routes/_site.federation.events.tsx", "border-foreground/10", 1],
  ["src/routes/_site.federation.events.tsx", "divide-foreground/10", 1],
  ...
  ["src/routes/_site.news.$newsId.tsx", "bg-brand-navy/25", 1],
  ["src/routes/_site.news.$newsId.tsx", "bg-muted/60", 1],
  ["src/routes/_site.news.$newsId.tsx", "bg-muted/70", 1],
  ["src/routes/_site.news.$newsId.tsx", "border-brand-navy/15", 1],
  ["src/routes/_site.news.$newsId.tsx", "ring-black/5", 2],
