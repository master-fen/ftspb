...
const LEADERSHIP_MOCK = [
  {
    ...
    role: "Президент",
    bio:
      "Краткая биография и зона ответственности. Здесь появится информация о деятельности, достижениях и направлениях работы в Федерации тенниса Санкт-Петербурга.",
