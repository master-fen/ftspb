    ...
    <article className="max-w-3xl font-ui text-[15px] leading-[1.45] text-foreground">
      <section id="charter-intro" className="scroll-mt-6">
        ...
        <div className="mt-5 space-y-3">
          <p>
            ...
            порядок членства, структуру органов управления, их полномочия, а также основные принципы
        ...
        <dl className="mt-3 space-y-3">
          <div>
            ...
            <dd className="mt-0.5 text-foreground/80">
              Устав Санкт-Петербургской Региональной Общественной организации «Спортивная Федерация
              тенниса»
            </dd>
          </div>
          <div>
      ...
      <section id="scope" className="mt-8 scroll-mt-6">
        ...
        <div className="mt-3 space-y-3 text-foreground/80">
          <p>
            Устав устанавливает основные принципы деятельности Федерации: её цели и задачи, права и
            обязанности, порядок членства, устройство руководящих и контрольно-ревизионных органов,
            правила формирования и использования имущества и средств.
          </p>
          <p>
          ...
          <p>
            Документ также определяет порядок внесения изменений в Устав и условия реорганизации и
            ликвидации Федерации.
          </p>
        </div>
      </section>
        ...
        <div className="mt-4 space-y-4">
          <div>
            ...
            <p className="mt-1 text-foreground/80">
              ...
              подготовка спортсменов сборных команд Санкт-Петербурга и защита общих интересов членов
              организации.
            </p>
          </div>
          <div>
            ...
            <p className="mt-1 text-foreground/80">
              Членство является добровольным. Участниками могут быть физические лица и общественные
              объединения, признающие цели Федерации и принимающие участие в её деятельности.
            </p>
          </div>
          <div>
