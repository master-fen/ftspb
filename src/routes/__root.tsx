  ...
  head: () => ({
    meta: [
      ...
      { name: "viewport", content: "width=device-width, initial-scale=1" },
      {
        ...
        content: "X56jE87UpS4nyxTdPbVgiuWRwt5ie9uLCbKsKzl6T4o",
      },
      ...
      { property: "og:title", content: "Федерация тенниса Санкт-Петербурга" },
      {
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Manrope:wght@400;500;600;700;800;900&family=Inter:wght@400;500;600;700;800&display=swap",
      },
    ],
  }),
