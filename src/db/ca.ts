/**
 * Публичный CA-сертификат Timeweb Cloud, вшитый в код, чтобы не читать
 * certs/timeweb-ca.crt с диска в рантайме. Файл в certs/ остаётся для
 * ручных подключений (psql, drizzle-kit studio из консоли) — держите их
 * синхронными при ротации сертификата.
 */
export const TIMEWEB_CA = `-----BEGIN CERTIFICATE-----
